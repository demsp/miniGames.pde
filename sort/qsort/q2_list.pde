 ...
 */
 ...
 mods[6] = new Module(7*30,  60);
 mods[7] = new Module(8*30,  10);
 mods[8] = new Module(9*30,  10);
 mods[9] = new Module(10*30,  90);
 mods[10] = new Module(11*30,  110);
 mods[11] = new Module(12*30,  100);
 mods[12] = new Module(13*30,  170);
 mods[13] = new Module(14*30,  150);
 mods[14] = new Module(15*30,  180);
}
